...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("BoardEvents.LetterSwipedWithLetterInformation")))
@interface SharedBoardEventsLetterSwipedWithLetterInformation : SharedBoardEvents
- (instancetype)initWithLetter:(NSSet<SharedInt *> *)letter __attribute__((swift_name("init(letter:)"))) __attribute__((objc_designated_initializer));
- (SharedBoardEventsLetterSwipedWithLetterInformation *)doCopyLetter:(NSSet<SharedInt *> *)letter __attribute__((swift_name("doCopy(letter:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSSet<SharedInt *> *letter __attribute__((swift_name("letter")));
@end
